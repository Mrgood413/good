...
class ProductController {
    ...
    // Show product list (open to all users)
    public function index() {
        $categoryModel = new CategoryModel($this->db);
    $categories = $categoryModel->getCategories(); // Lấy danh mục
    ...
    if (isset($_GET['category']) && !empty($_GET['category'])) {
        ...
        $products = $this->productModel->getProducts(); // Hiển thị tất cả sản phẩm
    }
        include 'app/views/product/list.php';
    }

    // View product details (open to all users)
    ...
    // Save new product (only accessible to Admins)
    ...
    // Edit product (only accessible to Admins)
    ...
    // Delete product (only accessible to Admins)
